...
class Story(models.Model):
    ...
    media_url = models.CharField(max_length=255)  # URL to image or video
...
class Notification(models.Model):
    ...
    timestamp = models.DateTimeField(auto_now_add=True)
    user = models.ForeignKey(User, on_delete=models.CASCADE)
    content = models.TextField()  # Add a field to store the message content

    def __str__(self):
        return f'{self.from_user} {self.notification_type} {self.user}'
