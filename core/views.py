...
def search_results(request):
    ...
    if query:
        ...
        search_results = [get_object_or_404(Profile, user=user) for user in user_results]
...
def group_chat(request, group_id):
    ...
    return render(request, 'chats/group_chat.html', {'group': group, 'messages': messages})
...
def all_messages(request):
    ...
    return render(request, 'chats/all_messages.html', {'all_messages': all_messages})
